...
for (i in 1:length(taxa)) {
  ...
  springNonFix[[i]] <- buildLandcoverModTab(taxa[[i]], fD_spring, 4)
...
for (i in 1:length(taxa)) {
  ...
  springFix[[i]] <- buildLandcoverModTab(taxa[[i]], fD_springFixed, 4)
...
for (i in 1:length(taxa)) {
  ...
  fallNonFix[[i]] <- buildLandcoverModTab(taxa[[i]], fD_fall, 4)
...
for (i in 1:length(taxa)) {
  ...
  fallFix[[i]] <- buildLandcoverModTab(taxa[[i]], fD_fallFixed, 4)
