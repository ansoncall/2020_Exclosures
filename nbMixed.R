...
tab_nb_anth_sp_scaled <- rbind(sig1_dredge,
                               sig2_dredge,
                               sig3_dredge,
                               sig4_dredge,
                               sig5_dredge,
...
# rbind and recalc AIC
tab_nb_anth_fa_scaled <- rbind(sig1_dredge,
                               sig2_dredge,
                               sig3_dredge,
                               sig4_dredge,
                               sig5_dredge,
...
gmod_no <- glmmTMB(Arachnida ~
                     ...
                     # landcover effects
                     alfalfa_no + naturalArid_no + dirt_no + ag_no +
                     impermeable_no + weedy_no + water_no + div_no + divShan_no,
...
# rbind and recalc AIC
tab_nb_ara_sp_scaled <- rbind(sig1_dredge,
                              sig2_dredge,
                              sig3_dredge,
                              sig4_dredge,
                              sig5_dredge,
...
# rbind and recalc AIC
tab_nb_ara_fa_scaled <- rbind(sig1_dredge,
                              sig2_dredge,
                              sig3_dredge,
                              sig4_dredge,
                              sig5_dredge,
...
# rbind and recalc AIC
tab_nb_cocc_sp_scaled <- rbind(sig1_dredge,
                               sig2_dredge,
                               sig3_dredge,
                               sig4_dredge,
                               sig5_dredge,
...
# rbind and recalc AIC
tab_nb_cocc_fa_scaled <- rbind(sig1_dredge,
                               sig2_dredge,
                               sig3_dredge,
                               sig4_dredge,
                               sig5_dredge,
...
# rbind and recalc AIC
tab_nb_geo_sp_scaled <- rbind(sig1_dredge,
                              sig2_dredge,
                              sig3_dredge,
                              sig4_dredge,
                              sig5_dredge,
...
# rbind and recalc AIC
tab_nb_geo_fa_scaled <- rbind(sig1_dredge,
                              sig2_dredge,
                              sig3_dredge,
                              sig4_dredge,
                              sig5_dredge,
...
# rbind and recalc AIC
tab_nb_ich_sp_scaled <- rbind(sig1_dredge,
                              sig2_dredge,
                              sig3_dredge,
                              sig4_dredge,
                              sig5_dredge,
...
# rbind and recalc AIC
tab_nb_ich_fa_scaled <- rbind(sig1_dredge,
                              sig2_dredge,
                              sig3_dredge,
                              sig4_dredge,
                              sig5_dredge,
