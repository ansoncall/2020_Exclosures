...
gmod_sig1 <- glmmTMB(Anthocoridae ~ Treatment + log_AllAph + wateringMethod + # non-landcover effects
                       alfalfa_sig1 + naturalArid_sig1 + dirt_sig1 + ag_sig1 + impermeable_sig1 + weedy_sig1 + water_sig1 + div_sig1 + divShan_sig1 + # alfalfaPerim + weedyPerim + agPerim + impermeablePerim + wetPerim + naturalAridPerim + surfaceWaterPerim + # landcover effects
...
gmod_sig2 <- glmmTMB(Anthocoridae ~ Treatment + log_AllAph + wateringMethod + # non-landcover effects
                       alfalfa_sig2 + naturalArid_sig2 + dirt_sig2 + ag_sig2 + impermeable_sig2 + weedy_sig2 + water_sig2 + div_sig2 + divShan_sig2 + # alfalfaPerim + weedyPerim + agPerim + impermeablePerim + wetPerim + naturalAridPerim + surfaceWaterPerim + # landcover effects
                       (1 | Site / Field), # nested random effects
                     data = df_sp, family = "nbinom2")
gmod_sig3 <- glmmTMB(Anthocoridae ~ Treatment + log_AllAph + wateringMethod + # non-landcover effects
                       alfalfa_sig3 + naturalArid_sig3 + dirt_sig3 + ag_sig3 + impermeable_sig3 + weedy_sig3 + water_sig3 + div_sig3 + divShan_sig3 + # alfalfaPerim + weedyPerim + agPerim + impermeablePerim + wetPerim + naturalAridPerim + surfaceWaterPerim + # landcover effects
                       (1 | Site / Field), # nested random effects
                     data = df_sp, family = "nbinom2")
gmod_sig4 <- glmmTMB(Anthocoridae ~ Treatment + log_AllAph + wateringMethod + # non-landcover effects
                       alfalfa_sig4 + naturalArid_sig4 + dirt_sig4 + ag_sig4 + impermeable_sig4 + weedy_sig4 + water_sig4 + div_sig4 + divShan_sig4 + # alfalfaPerim + weedyPerim + agPerim + impermeablePerim + wetPerim + naturalAridPerim + surfaceWaterPerim + # landcover effects
                       (1 | Site / Field), # nested random effects
                     data = df_sp, family = "nbinom2")
gmod_sig5 <- glmmTMB(Anthocoridae ~ Treatment + log_AllAph + wateringMethod + # non-landcover effects
                       alfalfa_sig5 + naturalArid_sig5 + dirt_sig5 + ag_sig5 + impermeable_sig5 + weedy_sig5 + water_sig5 + div_sig5 + divShan_sig5 + # alfalfaPerim + weedyPerim + agPerim + impermeablePerim + wetPerim + naturalAridPerim + surfaceWaterPerim + # landcover effects
                       (1 | Site / Field), # nested random effects
                     data = df_sp, family = "nbinom2")
gmod_const <- glmmTMB(Anthocoridae ~ Treatment + log_AllAph + wateringMethod + # non-landcover effects
                        alfalfa_const + naturalArid_const + dirt_const + ag_const + impermeable_const + weedy_const + water_const + div_const + divShan_const + # alfalfaPerim + weedyPerim + agPerim + impermeablePerim + wetPerim + naturalAridPerim + surfaceWaterPerim + # landcover effects
                        (1 | Site / Field), # nested random effects
                      data = df_sp, family = "nbinom2")
gmod_no <- glmmTMB(Anthocoridae ~ Treatment + log_AllAph + wateringMethod + # non-landcover effects
                     alfalfa_no + naturalArid_no + dirt_no + ag_no + impermeable_no + weedy_no + water_no + div_no + divShan_no + # alfalfaPerim + weedyPerim + agPerim + impermeablePerim + wetPerim + naturalAridPerim + surfaceWaterPerim + # landcover effects
                     (1 | Site / Field), # nested random effects
                   data = df_sp, family = "nbinom2")
...
tab_nb_anth_sp_scaled <- rbind(sig1_dredge, sig2_dredge, sig3_dredge, sig4_dredge, sig5_dredge, const_dredge, no_dredge)

## Fall ####
gmod_sig1 <- glmmTMB(Anthocoridae ~ Treatment + log_AllAph + wateringMethod + # non-landcover effects
                       alfalfa_sig1 + naturalArid_sig1 + dirt_sig1 + ag_sig1 + impermeable_sig1 + weedy_sig1 + water_sig1, # + alfalfaPerim + weedyPerim + agPerim + impermeablePerim + wetPerim + naturalAridPerim + surfaceWaterPerim, # landcover effects
                       # nested random effects not fitting_
...
# rbind and recalc AIC
tab_nb_anth_fa_scaled <- rbind(sig1_dredge, sig2_dredge, sig3_dredge, sig4_dredge, sig5_dredge, const_dredge, no_dredge)
...
# rbind and recalc AIC
tab_nb_ara_sp_scaled <- rbind(sig1_dredge, sig2_dredge, sig3_dredge, sig4_dredge, sig5_dredge, const_dredge, no_dredge)

## Fall ####
gmod_sig1 <- glmmTMB(Arachnida ~ Treatment + log_AllAph + wateringMethod + # non-landcover effects
                       alfalfa_sig1 + naturalArid_sig1 + dirt_sig1 + ag_sig1 + impermeable_sig1 + weedy_sig1 + water_sig1, # + alfalfaPerim + weedyPerim + agPerim + impermeablePerim + wetPerim + naturalAridPerim + surfaceWaterPerim, # landcover effects
                       # nested random effects not fitted_
                     data = df_fa, family = "nbinom2")
gmod_sig2 <- glmmTMB(Arachnida ~ Treatment + log_AllAph + wateringMethod + # non-landcover effects
                       alfalfa_sig2 + naturalArid_sig2 + dirt_sig2 + ag_sig2 + impermeable_sig2 + weedy_sig2 + water_sig2 + div_sig2 + divShan_sig2 + # alfalfaPerim + weedyPerim + agPerim + impermeablePerim + wetPerim + naturalAridPerim + surfaceWaterPerim + # landcover effects
                       (1 | Site / Field), # nested random effects
...
# rbind and recalc AIC
tab_nb_ara_fa_scaled <- rbind(sig1_dredge, sig2_dredge, sig3_dredge, sig4_dredge, sig5_dredge, const_dredge, no_dredge)
...
# rbind and recalc AIC
tab_nb_cocc_sp_scaled <- rbind(sig1_dredge, sig2_dredge, sig3_dredge, sig4_dredge, sig5_dredge, const_dredge, no_dredge)
...
# rbind and recalc AIC
tab_nb_cocc_fa_scaled <- rbind(sig1_dredge, sig2_dredge, sig3_dredge, sig4_dredge, sig5_dredge, const_dredge, no_dredge)
...
# rbind and recalc AIC
tab_nb_geo_sp_scaled <- rbind(sig1_dredge, sig2_dredge, sig3_dredge, sig4_dredge, sig5_dredge, const_dredge, no_dredge)
...
# rbind and recalc AIC
tab_nb_geo_fa_scaled <- rbind(sig1_dredge, sig2_dredge, sig3_dredge, sig4_dredge, sig5_dredge, const_dredge, no_dredge)
...
# rbind and recalc AIC
tab_nb_ich_sp_scaled <- rbind(sig1_dredge, sig2_dredge, sig3_dredge, sig4_dredge, sig5_dredge, const_dredge, no_dredge)
...
# rbind and recalc AIC
tab_nb_ich_fa_scaled <- rbind(sig1_dredge, sig2_dredge, sig3_dredge, sig4_dredge, sig5_dredge, const_dredge, no_dredge)

stopCluster(clust)

# put all tabs in lists
nb_scaled <- list(
  "tab_nb_anth_sp_scaled" = tab_nb_anth_sp_scaled,
  "tab_nb_anth_fa_scaled" = tab_nb_anth_fa_scaled,
  "tab_nb_ara_sp_scaled" = tab_nb_ara_sp_scaled,
  "tab_nb_ara_fa_scaled" = tab_nb_ara_fa_scaled,
  "tab_nb_cocc_sp_scaled" = tab_nb_cocc_sp_scaled,
  "tab_nb_cocc_fa_scaled" = tab_nb_cocc_fa_scaled,
  "tab_nb_geo_sp_scaled" = tab_nb_geo_sp_scaled,
  "tab_nb_geo_fa_scaled" = tab_nb_geo_fa_scaled,
  "tab_nb_ich_sp_scaled" = tab_nb_ich_sp_scaled,
  "tab_nb_ich_fa_scaled" = tab_nb_ich_fa_scaled
)

# clean env
rm(
  tab_nb_anth_sp_scaled,
  tab_nb_anth_fa_scaled,
  tab_nb_ara_sp_scaled,
  tab_nb_ara_fa_scaled,
  tab_nb_cocc_sp_scaled,
  tab_nb_cocc_fa_scaled,
  tab_nb_geo_sp_scaled,
  tab_nb_geo_fa_scaled,
  tab_nb_ich_sp_scaled,
  tab_nb_ich_fa_scaled,
  sig1_dredge,
  sig2_dredge,
  sig3_dredge,
  sig4_dredge,
