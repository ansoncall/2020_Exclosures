...
tab_nb_anth_sp_ranked <- rbind(sig1_dredge, sig2_dredge, sig3_dredge, sig4_dredge, sig5_dredge, const_dredge, no_dredge)
...
# rbind and recalc AIC
tab_nb_anth_fa_ranked <- rbind(sig1_dredge, sig2_dredge, sig3_dredge, sig4_dredge, sig5_dredge, const_dredge, no_dredge)
...
# rbind and recalc AIC
tab_nb_ara_sp_ranked <- rbind(sig1_dredge, sig2_dredge, sig3_dredge, sig4_dredge, sig5_dredge, const_dredge, no_dredge)
...
# rbind and recalc AIC
tab_nb_ara_fa_ranked <- rbind(sig1_dredge, sig2_dredge, sig3_dredge, sig4_dredge, sig5_dredge, const_dredge, no_dredge)
...
# rbind and recalc AIC
tab_nb_cocc_sp_ranked <- rbind(sig1_dredge, sig2_dredge, sig3_dredge, sig4_dredge, sig5_dredge, const_dredge, no_dredge)
...
gmod_sig3 <- glmmTMB(Coccinellidae ~ Treatment + log_AllAph + wateringMethod + # non-landcover effects
                       alfalfa_sig3 + naturalArid_sig3 + dirt_sig3 + ag_sig3 + impermeable_sig3 + weedy_sig3 + water_sig3 + div_sig3 + divShan_sig3 + # landcover effects
                       (1 | Site), # nested random effects NOT fitted, simplifying to site only_
                     data = df_fa_rnk, family = "nbinom2")
gmod_sig4 <- glmmTMB(Coccinellidae ~ Treatment + log_AllAph + wateringMethod + # non-landcover effects
                       alfalfa_sig4 + naturalArid_sig4 + dirt_sig4 + ag_sig4 + impermeable_sig4 + weedy_sig4 + water_sig4 + div_sig4 + divShan_sig4 + # landcover effects
...
# rbind and recalc AIC
tab_nb_cocc_fa_ranked <- rbind(sig1_dredge, sig2_dredge, sig3_dredge, sig4_dredge, sig5_dredge, const_dredge, no_dredge)
...
# rbind and recalc AIC
tab_nb_geo_sp_ranked <- rbind(sig1_dredge, sig2_dredge, sig3_dredge, sig4_dredge, sig5_dredge, const_dredge, no_dredge)
...
# rbind and recalc AIC
tab_nb_geo_fa_ranked <- rbind(sig1_dredge, sig2_dredge, sig3_dredge, sig4_dredge, sig5_dredge, const_dredge, no_dredge)
...
# rbind and recalc AIC
tab_nb_ich_sp_ranked <- rbind(sig1_dredge, sig2_dredge, sig3_dredge, sig4_dredge, sig5_dredge, const_dredge, no_dredge)
...
# rbind and recalc AIC
tab_nb_ich_fa_ranked <- rbind(sig1_dredge, sig2_dredge, sig3_dredge, sig4_dredge, sig5_dredge, const_dredge, no_dredge)

stopCluster(clust)

# put all tabs in lists
nb_ranked <- list(
  "tab_nb_anth_sp_ranked" = tab_nb_anth_sp_ranked,
  "tab_nb_anth_fa_ranked" = tab_nb_anth_fa_ranked,
  "tab_nb_ara_sp_ranked" = tab_nb_ara_sp_ranked,
  "tab_nb_ara_fa_ranked" = tab_nb_ara_fa_ranked,
  "tab_nb_cocc_sp_ranked" = tab_nb_cocc_sp_ranked,
  "tab_nb_cocc_fa_ranked" = tab_nb_cocc_fa_ranked,
  "tab_nb_geo_sp_ranked" = tab_nb_geo_sp_ranked,
  "tab_nb_geo_fa_ranked" = tab_nb_geo_fa_ranked,
  "tab_nb_ich_sp_ranked" = tab_nb_ich_sp_ranked,
  "tab_nb_ich_fa_ranked" = tab_nb_ich_fa_ranked
)

# clean env
rm(
  tab_nb_anth_sp_ranked,
  tab_nb_anth_fa_ranked,
  tab_nb_ara_sp_ranked,
  tab_nb_ara_fa_ranked,
  tab_nb_cocc_sp_ranked,
  tab_nb_cocc_fa_ranked,
  tab_nb_geo_sp_ranked,
  tab_nb_geo_fa_ranked,
  tab_nb_ich_sp_ranked,
  tab_nb_ich_fa_ranked,
  sig1_dredge,
  sig2_dredge,
  sig3_dredge,
  sig4_dredge,
