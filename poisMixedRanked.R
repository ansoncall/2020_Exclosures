...
sig5_dredge <- dredge(gmod_sig5,
                      ...
                      trace = 2,
                      cluster = clust)
const_dredge <- dredge(gmod_const, m.lim = c(0, 3),
                       fixed = "cond(Treatment)",
                       trace = 2,
                       cluster = clust)
no_dredge <- dredge(gmod_no, m.lim = c(0, 3),
                    fixed = "cond(Treatment)",
                    trace = 2,
                    cluster = clust)

# rbind and recalc AIC
tab_pois_anth_sp_ranked <- rbind(sig1_dredge,
                                 sig2_dredge,
                                 sig3_dredge,
                                 sig4_dredge,
                                 sig5_dredge,
...
# rbind and recalc AIC
tab_pois_anth_fa_ranked <- rbind(sig1_dredge,
                                 sig2_dredge,
                                 sig3_dredge,
                                 sig4_dredge,
                                 sig5_dredge,
...
# rbind and recalc AIC
tab_pois_ara_sp_ranked <- rbind(sig1_dredge,
                                sig2_dredge,
                                sig3_dredge,
                                sig4_dredge,
                                sig5_dredge,
...
# rbind and recalc AIC
tab_pois_ara_fa_ranked <- rbind(sig1_dredge,
                                sig2_dredge,
                                sig3_dredge,
                                sig4_dredge,
                                sig5_dredge,
...
# rbind and recalc AIC
tab_pois_cocc_sp_ranked <- rbind(sig1_dredge,
                                 sig2_dredge,
                                 sig3_dredge,
                                 sig4_dredge,
                                 sig5_dredge,
...
# rbind and recalc AIC
tab_pois_cocc_fa_ranked <- rbind(sig1_dredge,
                                 sig2_dredge,
                                 sig3_dredge,
                                 sig4_dredge,
                                 sig5_dredge,
...
# rbind and recalc AIC
tab_pois_geo_sp_ranked <- rbind(sig1_dredge,
                                sig2_dredge,
                                sig3_dredge,
                                sig4_dredge,
                                sig5_dredge,
...
# rbind and recalc AIC
tab_pois_geo_fa_ranked <- rbind(sig1_dredge,
                                sig2_dredge,
                                sig3_dredge,
                                sig4_dredge,
                                sig5_dredge,
...
# rbind and recalc AIC
tab_pois_ich_sp_ranked <- rbind(sig1_dredge,
                                sig2_dredge,
                                sig3_dredge,
                                sig4_dredge,
                                sig5_dredge,
...
# rbind and recalc AIC
tab_pois_ich_fa_ranked <- rbind(sig1_dredge,
                                sig2_dredge,
                                sig3_dredge,
                                sig4_dredge,
                                sig5_dredge,
